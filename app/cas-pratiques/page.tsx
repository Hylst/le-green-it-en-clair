...
export default function CasPratiquesPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-br from-teal-600 to-emerald-700 px-6 py-16 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mb-6 text-3xl font-bold text-white lg:text-4xl">Passez à l'action</h2>
          <p className="mb-8 text-lg text-teal-50">
            Maintenant que vous comprenez l'impact de vos appareils, découvrez les gestes concrets pour réduire votre
            empreinte numérique.
          </p>
