    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-emerald-50 via-teal-50 to-blue-50 px-6 py-16 lg:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="relative h-64 rounded-2xl overflow-hidden shadow-xl">
            <Image src="/circular-lifecycle-diagram-of-smartphone-from-mini.jpg" alt="Cycle de vie d'un smartphone" fill className="object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-16 lg:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-12 relative h-96 rounded-2xl overflow-hidden shadow-lg">
            <Image
              src="/infographic-showing-smartphone-environmental-impac.jpg"
              alt="Impact environnemental d'un smartphone"
              fill
          ...
          <div>
            <VisualAnalogy
              title="15 000 km parcourus"
              description="Votre smartphone a voyagé l'équivalent de Paris à Sydney avant d'arriver dans votre poche !"
              visual={{
                items: [
                  { icon: "🚢", count: 1, label: "Cargo maritime" },
                  { icon: "✈️", count: 1, label: "Transport aérien" },
                  { icon: "🚚", count: 1, label: "Livraison locale" },
                ],
              }}
              color="blue"
            />
