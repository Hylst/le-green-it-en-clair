    ...
    questions: [
      {
        ...
        a: "Actions principales : 1) Éteindre complètement (pas juste en veille) la nuit et quand inutilisés, en visant d'abord les grosses veilles : box internet (environ 26 kWh/an économisés en la débranchant la nuit, soit ~5 €/an, Arcep 2026), console en démarrage rapide (10 à 15 W en veille contre 0,5 W en arrêt économe, Microsoft 2023), appareils anciens. 2) Sur une TV ou un ordinateur récents, la veille simple est plafonnée à 0,5 W dans l'UE (règlement 2023/826) : 10 h d'extinction économisent ≈ 5 Wh par appareil (0,5 × 10), peu à l'unité — le gain vient du cumul des appareils. 3) Le pic de courant au rallumage existe mais ne dure que des millisecondes : même en prenant large (100 W pendant 1 seconde, soit ≈ 0,03 Wh), il pèse plus de cent fois moins que les ≈ 5 Wh de veille évités — éteindre reste toujours gagnant énergétiquement. 4) Exceptions : garder la box branchée si le téléphone fixe, un enregistrement programmé ou des objets connectés en dépendent (la resynchronisation prend plusieurs minutes) ; laisser l'imprimante jet d'encre en veille entre deux impressions proches, chaque allumage lançant souvent un cycle de nettoyage qui consomme de l'encre (Epson, guides en ligne) ; en journée, mise en veille de l'ordinateur (réveil en quelques secondes) et extinction la nuit (Ressources naturelles Canada, 2014). 5) Régler luminosité à 50 % max, 6) Activer mode économie d'énergie, 7) Privilégier Wi-Fi à 4G/5G (environ 4 à 5 fois moins énergivore en streaming), 8) Utiliser multiprise avec interrupteur pour couper les veilles d'un geste (ADEME, 2026).",
      },
      {
