    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-teal-50 to-blue-50 px-6 py-20 lg:py-32">
        <div className="absolute inset-0 opacity-20">
          <Image src="/abstract-green-technology-network-with-leaves-and-.jpg" alt="Green IT concept" fill className="object-cover" priority />
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative h-80 rounded-2xl overflow-hidden shadow-lg">
              <Image
                ...
                alt="Impact des déchets électroniques"
                fill
