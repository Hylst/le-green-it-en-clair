                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-card p-3 rounded-lg border border-chart-3/20">
                        ...
                        <ul className="text-sm text-muted-foreground space-y-1">
                          ...
                          <li>• Émissions <Acronym title="Gaz à Effet de Serre" glossary="ges">GES</Acronym> liées au numérique (<Acronym title="Périmètres de comptabilité carbone : scope 1 = émissions directes, scope 2 = énergie achetée, scope 3 = autres émissions indirectes">scope 1, 2, 3</Acronym>)</li>
