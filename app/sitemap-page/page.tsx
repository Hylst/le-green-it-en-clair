  ...
  const siteStructure = [
    ...
    },
    {
      ...
      pages: [
        ...
        { href: "/mythes", label: "Mythes vs Réalités", description: "18 idées reçues passées au crible" },
        ...
        { href: "/blog/greenwashing-numerique-reperes", label: "Greenwashing numérique", description: "3 réflexes pour trier les promesses" },
