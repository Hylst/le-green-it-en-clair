    ...
    [
      {
        ...
        serveursFranceNote: "",
        wue: 0.015,
        wueNote: "Impact report 2024 (données 2023)",
        cue: null,
        cueNote: null,
        cycleVie: "Serveurs prolongés à 15 ans (88 % des serveurs de 2015 encore en service en 2024) — Impact report 2024",
        pueEstime: false,
      ...
      },
      {
        ...
        wue: null,
        wueNote: "DC3 Paris : 0,00009 L/kWh, DC4 Paris : 0,00002 L/kWh (données 2024, page Environmental leadership)",
        cue: null,
        cueNote: null,
        cycleVie: "Serveurs reconditionnés jusqu'à 10 ans (Transformers, ~15 000 serveurs ; >12 000 disques en 2024) — page Environmental leadership",
        pueEstime: false,
        renouvelableEstime: false,
      },
      {
        ...
        cue: null,
        cueNote: "0,18 kgCO₂e/kWh location-based (données 2023, blog officiel Grégory Lebourg 27/02/2024 — à confirmer dans l'URD)",
        cycleVie: "100 % des serveurs démontés et testés, durée moyenne 4,5 ans et jusqu'à 9 ans — page Environnement (consultée en 09/2026)",
        pueEstime: false,
        renouvelableEstime: false,
      },
      {
        ...
        cue: null,
        cueNote: null,
        cycleVie: "≈ 8,8 M de composants récoltés en 2024, 84 % de déchets détournés (durée de vie non publiée, page Circularity 2025)",
        pueEstime: false,
        renouvelableEstime: false,
      },
      {
        ...
        serveursFranceNote: "",
        wue: 0.27,
        wueNote: "Page efficacité Microsoft, mondial FY25 (0,30 en FY24)",
        cue: null,
        cueNote: null,
        cycleVie: "Circular Centers : 90 % de réemploi des composants visé (durée de vie non publiée, blog Azure 2022)",
        pueEstime: false,
        renouvelableEstime: false,
      },
      {
        ...
        serveursFranceNote: "",
        wue: 0.12,
        wueNote: "Page AWS Cloud, Amazon Sustainability (2025 ; 0,15 en 2024)",
        cue: null,
        cueNote: null,
        cycleVie: "225 000 tCO₂e évitées depuis 2020 via réemploi (durée de vie non publiée, page AWS Cloud 2025)",
        pueEstime: false,
        renouvelableEstime: false,
      },
      {
      ...
      },
      {
        ...
        serveursFranceNote: "",
        wue: 0,
        wueNote: "Refroidissement 100 % air, WUE nul déclaré (page Sustainability, 2026)",
        cue: null,
        cueNote: null,
        cycleVie: "Durée moyenne portée à 8 ans (Server Auction, réparation, réemploi) — page Sustainability (2026)",
        pueEstime: false,
        renouvelableEstime: false,
      },
      {
        ...
        wue: 0.003,
        wueNote: "Rapport développement durable 2024 (tableau ESG : WUE 0,003 L/kWh en 2024)",
        cue: null,
        cueNote: "0,003 kgCO₂e/kWh (rapport développement durable 2024, tableau ESG)",
        cycleVie: "96,2 % des déchets recyclés ou réutilisés en 2024 (durée des serveurs non publiée, rapport développement durable 2024)",
        pueEstime: false,
        renouvelableEstime: false,
      },
      {
      ...
      },
      {
        ...
        cue: null,
        cueNote: null,
        cycleVie: "Réutilisation, revente et recyclage décrits (durée de vie non publiée, page Hébergement vert 2026)",
        pueEstime: false,
        renouvelableEstime: false,
      },
      {
      ...
      },
      {
        ...
        cue: null,
        cueNote: null,
        cycleVie: "Gammes Classic/Regen reconditionnées (durée de vie non publiée, page produits reconditionnés 2026)",
        pueEstime: true,
        renouvelableEstime: false,
      },
      {
      ...
      },
      {
        ...
        cue: null,
        cueNote: null,
        cycleVie: "Âge moyen du parc 3 ans et plus, réaffectation interne, réseau majoritairement reconditionné — page Sustainability (2026)",
        pueEstime: true,
        renouvelableEstime: false,
      },
    ] as CloudProvider[]
                  ...
                  <MoreDetails title="Eau, carbone et cycle de vie">
                    <ul className="space-y-1 text-left text-sm text-muted-foreground">
                      <li>
                        ...
                        {provider.wue === null ? (
                          provider.wueNote ?? <span>Non publié</span>
                        ) : (
                      ...
                      <li>
                        ...
                        {provider.cue === null ? (
                          provider.cueNote ?? <span>Non publié</span>
                        ) : (
