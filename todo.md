...
- [ ] Reste : régénérer les 2 images FR (`smartphone-impact-infographic` en anglais 55 kg/13 000 L, `comparison-chart` charabia), quelques styles de langage, erreurs `tsc` pré-existantes.
