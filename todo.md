...
- [ ] success stories avec des vrais cas : 1er portrait fait le 17/09 (Back Market en article blog, faits publics vérifiés à la main, sans logo, sans autorisation nécessaire pour des faits) ; reste Fairphone, Envie (demander l’autorisation écrite avant logo, photos ou données non publiées)
- [x] vidéos le 17/09 : section « Vidéos » dans `/ressources` (collection Canal-U « Sobriété numérique » UVED/Alt IMPACT vérifiée à la main : 1 intégrée en lecture au clic via oEmbed officiel + 5 cartes avec durée et lien, licence CC BY-NC-SA rappelée). Reste : récupérer les 5 codes oEmbed manquants (anti-robot le 17/09) pour intégrer les autres au clic ; visuel du portrait Back Market branché le 17/09 (`blog-back-market-portrait.webp`).
...
- [ ] contrôle trimestriel des liens externes (fait le 17/09 : 16 domaines OK dont 6 en 301 normal et ademe.fr en 403 anti-bot connu ; à relancer tous les 3 mois : ressources fiches, vidéos Canal-U, sources blog, veille RSS ; en suspens : 5 codes oEmbed Canal-U bloqués par l’anti-robot, URL GreenFrame/EcoIndex non vérifiée)
